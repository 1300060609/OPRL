...
"""Implementation of the OPRL model."""
...
class OPRLConfig:
    ...
    @classmethod
    def from_dict(cls, config: Dict) -> 'OPRLConfig':
...
class OPRL(BaseModule):
    """An implementation of OPRL [borders2013]_.
    ...
    .. seealso:: https://github.com/thunlp/OpenKE/blob/OpenKE-PyTorch/models/OPRL.py
    """
    model_name = 'OPRL'
    ...
    def __init__(self, config: Dict) -> None:
        ...
        config = OPRLConfig.from_dict(config)
    ...
    def forward(self, batch_positives, batch_negatives):
        ...
        self.entity_embeddings.weight.data = self.entity_embeddings.weight.data.div(
            norms.view(self.num_entities, 1).expand_as(self.entity_embeddings.weight)) # 向量归一化，分量除以lp_norm-范数
