...
IMPORTERS: Dict[str, Callable[[str], np.ndarray]] = {
    ...
    for entry_point in iter_entry_points(group='OPRL.data.importer')
}
...
HPO_ITERS_ERROR_MSG = 'An error occurred, please type input_data_guo a positive integer for the maximum number of iterations.'
...
RELATION_EMBEDDING_DIMENSION_ERROR_MSG = 'An error occurred, please type input_data_guo an integer as embedding dimension such as 30.'
...
MARGIN_LOSS_PRINT_MSG = 'Please type input_data_guo the margin losses:'
MARGIN_LOSS_PROMPT_MSG = '> Margin loss:'
MARGIN_LOSS_ERROR_MSG = 'An error occurred, please type input_data_guo a float value.'

LEARNING_RATE_PRINT_MSG = 'Please type input_data_guo the learning rate.'
